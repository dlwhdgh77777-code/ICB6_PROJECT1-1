...
@st.cache_data
def load_data():
    # 1. 카페(기존 공급) 데이터 로드 (사용자 지정 경로)
    # [NEW PATH] project0117/previous_results/data/서울시_동별_업종별_점포수_상세.csv
    cafe_rel = '../project0117/previous_results/data/서울시_동별_업종별_점포수_상세.csv'
